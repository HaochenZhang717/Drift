...
class TSVQVAE(nn.Module):
    def __init__(self,
        ...
        if getattr(args, 'input_emb_width', None) is not None:
            input_emb_width = int(args.input_emb_width)
            ...
            raise ValueError(
                f"Unknown dataname '{args.dataname}'. Pass --input-emb-width for custom datasets."
            )
