...
SAVE_ROOT="${SAVE_ROOT:-/mnt/unites8/playpen/haochenz/Drift/TimeMar}"
VQVAE_SAVE_ROOT="${VQVAE_SAVE_ROOT:-${SAVE_ROOT}/dual_vqvae}"
VAR_SAVE_ROOT="${VAR_SAVE_ROOT:-${SAVE_ROOT}/var}"
DEVICE="${DEVICE:-}"
