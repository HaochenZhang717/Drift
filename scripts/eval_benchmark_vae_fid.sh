...
SEED=${SEED:-42}
ETTM2_DIR=${ETTM2_DIR:-${PROJECT_ROOT}/logs/ImagenTime/ETTm2/1a746657-a3bf-4dc4-b145-12cf4422e977}
ETTH2_DIR=${ETTH2_DIR:-${PROJECT_ROOT}/logs/ImagenTime/ETTh2/075d365a-305c-4664-986a-c268eae56de6}
ETTM1_DIR=${ETTM1_DIR:-${PROJECT_ROOT}/logs/ImagenTime/ETTm1/e1126afd-35f2-46ee-a7e9-a0ca558476c4}
WEATHER_DIR=${WEATHER_DIR:-${PROJECT_ROOT}/logs/ImagenTime/Weather/80b0e9fb-777d-4282-bdbc-362cb6bd47c0}
AIRQUALITY_DIR=${AIRQUALITY_DIR:-${PROJECT_ROOT}/logs/ImagenTime/AirQuality/5db9c0c8-2560-4827-bd7d-259d201793ed}
