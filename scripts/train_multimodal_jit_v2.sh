...
CGM_ENHANCED_FEATURES_PATH="/playpen-shared/haochenz/AI-READI-Dataset/AI-READI-processed/cgm_enhanced_features_clean.csv"
...
python train_multimodal_jit_v2.py \
    --data_root ${DATA_ROOT} \
