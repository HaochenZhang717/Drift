...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train study-group-conditional JiT denoiser on AI-READI glucose windows")
    ...
    parser.add_argument("--output_dir", type=str, default="./outputs/cls_cond_jit")
